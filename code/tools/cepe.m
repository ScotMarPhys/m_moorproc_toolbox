function cp = cepe(s,t,p);

% CEPE.M calculates the specific heat of sea-water at constant pressure
%        as described in Landolt-Boernstein, New Series V/3 a, p. 247-250.
%
%        cp = cepe(s,t,p);
%
%        with matrices  p  : pressure in dbar
%                       t  : temperature in deg C
%                       s  : salinity in psu
%                       cp : specific heat at constant pressure in J/(K*kg)
%
%        check value :  cp(4000,13.5,35) = 3900.3 J/(K*kg)

%        by Ulf Garternicht in August 1994, IfM Kiel
disp('WARNING : the use of cepe.m is obsolete ! please use cpsw.m')
