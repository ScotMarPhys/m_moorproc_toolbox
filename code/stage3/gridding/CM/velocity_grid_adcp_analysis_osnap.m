...
eval(['print -djpeg ' plotpath 'f13_u_',prognam,'_',moor,'.jpg']);
...
eval(['print -djpeg ' plotpath 'f14_v_',prognam,'_',moor,'.jpg']);
...
eval(['print -djpeg ' plotpath 'f16_v_timeseries_',prognam,'_',moor,'.jpg']);
...
eval(['print -djpeg ' plotpath 'f17_rotation_angle_',prognam,'_',moor,'.jpg']);
...
eval(['print -djpeg ' plotpath 'f18_rotated_velocities_',prognam,'_',moor,'.jpg']);
