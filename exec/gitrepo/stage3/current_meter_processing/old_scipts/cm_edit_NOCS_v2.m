function cm_edit_NOCS_v2(moor,varargin)
%
...
if a>0
    ...
    procpath='/noc/mpoc/rpdmoc/users/dr400/osnap/data/moor/proc/'
end
...
depths(:,1) = id([iiS4;iiRCM11;iiARG;iiNOR;iiSEAGRD]);
depths(:,2) = z([iiS4;iiRCM11;iiARG;iiNOR;iiSEAGRD]);
...
if iiNOR>0 
    ...
    for i=1:length(vecNOR);
       ...
       if isunix
           ...
           logfile = ['./',moor,'_',sprintf('%4.4d',vecNOR(i)),'.edt.txt'];
           outfile1 = ['./',moor,'_',sprintf('%4.4d',vecNOR(i)),'.high_edt'];
           logfile1 = ['./',moor,'_',sprintf('%4.4d',vecNOR(i)),'.high_edt.txt'];
       elseif ispc
           infile = [procpath,moor,'\nor\',moor,'_',sprintf('%4.4d',vecNOR(i)),'.use'];
           outfile = ['.\',moor,'_',sprintf('%4.4d',vecNOR(i)),'.edt.txt'];
           outfile1 = ['./',moor,'_',sprintf('%4.4d',vecNOR(i)),'.high_edt'];
           logfile1 = ['./',moor,'_',sprintf('%4.4d',vecNOR(i)),'.high_edt.txt'];
       end
