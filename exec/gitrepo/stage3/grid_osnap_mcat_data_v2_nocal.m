...
% This routine uses uncalibrated data stored in the hydro_grid_v2_nocal
% directory
moor = 'rtwb2_02_2015';
...
%=========================================================================
% Grids all moored CTD Data - not calibrated yet, only processed for stage
% 1 and 2.
% paths
p_hydrogrid.basedir      = pathosnap;
p_hydrogrid.moor         = moor;   
p_hydrogrid.ini_path     = [p_hydrogrid.basedir '/data/moor/proc/hydro_grid_v2_nocal/ini'];
p_hydrogrid.rodbpath     = [p_hydrogrid.basedir '/data/moor/'];
p_hydrogrid.rodbctdpath  = [p_hydrogrid.basedir '/cruise_data/'];
p_hydrogrid.info_path    = [p_hydrogrid.rodbpath,'proc/hydro_grid_v2_nocal/',moor,'/'];
p_hydrogrid.mooringpath  = [pathosnap '/data/moor/proc/hydro_grid_v2_nocal/'];
p_hydrogrid.out_path     = [p_hydrogrid.basedir '/data/moor/proc/hydro_grid_v2_nocal/'];
p_hydrogrid.outname      = [moor,'_grid_v2_nocal.mat'];
p_hydrogrid.dataexternal_ctd_dir        = [p_hydrogrid.basedir '/cruise_data/'];
p_hydrogrid.datactd_ref_cruises   = {'kn221';'pe399';'dy053'};
