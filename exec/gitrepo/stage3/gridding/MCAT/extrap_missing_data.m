function [Tfs,Sfs,Pfs,TGfs,SGfs] = extrap_missing_data(path,wbfile,Tfs,Sfs,Pfs,TGfs,SGfs,JG,pgg)
...
print(gcf,'-dpng',fullfile(path, 'otherfigure','TSplusLinear.png'));
figure;
plot(t_RTWB,EB(1).S);hold on;
plot(t_RTWB,EB(1).Snew );
print(gcf,'-dpng',fullfile(path, 'otherfigure','EBold_EBnew.png'));
...
xlim(xlimit)
datetick('keeplimits')
print(gcf,'-dpng',fullfile(path, 'otherfigure','_EB1_corrected_temp.png'));