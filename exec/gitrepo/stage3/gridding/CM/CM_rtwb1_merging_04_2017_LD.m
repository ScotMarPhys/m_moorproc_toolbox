...
figure;
ax(1)=subplot(3,1,1);
[c,h]=contourf(JG,pgrid,UGfs,'LineColor','none');
...
ax(2)=subplot(3,1,2);
[c,h]=contourf(JG,pgrid,VGfs,'LineColor','none');
cmocean('balance',20,'pivot',0);
axis ij
datetick('x',10, 'keeplimits')
ylabel('Pressure (db)');
...
ax(3)=subplot(3,1,3);
[c,h]=contourf(JG,pgrid,WGfs,'LineColor','none');
cmocean('balance',20,'pivot',0);
axis ij
datetick('x',10, 'keeplimits')
ylabel('Pressure (db)');
...
print(gcf,[pathosnap '/Figures/CM/rtwb1_merge' ],'-djpeg');
