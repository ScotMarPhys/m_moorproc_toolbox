...
% The 250m one has longest record
% filling from bottom up (100m...)
% filling from top down (500m, 1000m, 1350m, 1780m)
...
%
% -----
RTWB1_merg_CM = stage3_4a_vertically_interp_data(Ufs,Vfs,Pfs,pgg,JG);
...
%
% -----
RTWB1_merg_CM = stage3_4c_time_interp_data(uuu,vvv,pgg,JG,idepth,RTWB1_merg_CM);
...
figure(1); clf
subplot(3,1,1)
[~,h] = contourf(JG , pgg, RTWB1_merg_CM.UGfs, contourlimituv); axis ij
...
subplot(3,1,3)
[C,h] = contourf(JG , pgg, RTWB1_merg_CM.UGfs2, contourlimituv); axis ij
set(h,'LineColor','none')
hold on
plot(JG,Pstacked','k')
polarmap,colorbar
...
figure(2);clf
subplot(3,1,1)
[C,h] = contourf(JG , pgg, RTWB1_merg_CM.VGfs, contourlimituv); axis ij
set(h,'LineColor','none')
hold on
plot(JG,Pstacked','k')
polarmap,colorbar
...
title('AFTER DESPIKING')
subplot(3,1,3)
[C,h] = contourf(JG , pgg, RTWB1_merg_CM.VGfs2, contourlimituv); axis ij
set(h,'LineColor','none')
hold on
plot(JG,Pstacked','k')
polarmap,colorbar
