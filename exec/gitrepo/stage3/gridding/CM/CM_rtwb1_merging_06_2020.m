%%  Code for the Merging of the Western Boundary 1
%%  Current Meter Data
%
%  Code History
% -------------
...
%
% -----
RTWB1_merg_CM = stage3_4a_vertically_interp_data(Ufs,Vfs,Wfs,Pfs,pgg,JG);
...
for i = 1 : length(RTWB1_merg_CM.UGfs(:,1))   % loop through each depth level

    [uuu(i,:),dx,ndx] = ddspike(RTWB1_merg_CM.UGfs(i,:),...
                        [-std_win*nanstd(RTWB1_merg_CM.UGfs(i,:)),...
                        std_win*nanstd(RTWB1_merg_CM.UGfs(i,:))],...
                        stddy_tol,[nloop],'y',NaN);
    [vvv(i,:),dx,ndx] = ddspike(RTWB1_merg_CM.VGfs(i,:),...
                        [-std_win*nanstd(RTWB1_merg_CM.VGfs(i,:)),...
                        std_win*nanstd(RTWB1_merg_CM.VGfs(i,:))],...
                        stddy_tol,[nloop],'y',NaN);
    [www(i,:),dx,ndx] = ddspike(RTWB1_merg_CM.WGfs(i,:),...
                        [-std_win*nanstd(RTWB1_merg_CM.WGfs(i,:)),...
                        std_win*nanstd(RTWB1_merg_CM.WGfs(i,:))],...
                        stddy_tol,[nloop],'y',NaN);
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
% -----
RTWB1_merg_CM = stage3_4c_time_interp_data(uuu,vvv,www,pgg,JG,idepth,RTWB1_merg_CM);
...
figure(1); clf
subplot(3,1,1)
contourf(JG , pgg, RTWB1_merg_CM.UGfs, contourlimituv); axis ij
hold on
plot(JG,Pstacked','k')
polarmap,colorbar
...
subplot(3,1,3)
contourf(JG , pgg, RTWB1_merg_CM.UGfs2, contourlimituv); axis ij
hold on
plot(JG,Pstacked','k')
polarmap,colorbar
caxis([min(contourlimituv) max(contourlimituv)]);    
...
figure(2);clf
subplot(3,1,1)
contourf(JG , pgg, RTWB1_merg_CM.VGfs, contourlimituv); axis ij
hold on
plot(JG,Pstacked','k')
polarmap,colorbar
datetick; ylabel('V')
...
title('AFTER DESPIKING')
subplot(3,1,3)
contourf(JG , pgg, RTWB1_merg_CM.VGfs2, contourlimituv); axis ij
hold on
plot(JG,Pstacked','k')
polarmap,colorbar
caxis([min(contourlimituv) max(contourlimituv)]);    
...
figure(3);clf
subplot(3,1,1)
contourf(JG , pgg, RTWB1_merg_CM.WGfs, contourlimitw); axis ij
hold on
plot(JG,Pstacked','k')
polarmap,colorbar
...
title('AFTER DESPIKING')
subplot(3,1,3)
contourf(JG , pgg, RTWB1_merg_CM.WGfs2, contourlimitw); axis ij
hold on
plot(JG,Pstacked','k')
polarmap,colorbar
caxis([min(contourlimitw) max(contourlimitw)]);    
