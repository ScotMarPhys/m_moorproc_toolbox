...
cruise = 'pe400';
cruise_ctd = 'pe400';
%cast = '17'; dateoffsetmc = 2013; % origine of the julian day in the matlab cnv files
%cast = '4'; dateoffsetmc = 2015; % origine of the julian day in the matlab cnv files
%cast = '3'; dateoffsetmc = 2015; % origine of the julian day in the matlab cnv files
cast = '35'; dateoffsetmc = 2015; % origine of the julian day in the matlab cnv files
doctd = 1; % whether to load and plot CTD data
jd0 = julian(2015,1,0,0); % set to current year
...
if exist('/Volumes/rpdmoc/rapid/data/exec/jc103/stage1/microcat/mc_call_caldip_jc103_v3.m','file')
    ...
    ctddir = '/home/mstar/osnap/data/pe400/';
end
