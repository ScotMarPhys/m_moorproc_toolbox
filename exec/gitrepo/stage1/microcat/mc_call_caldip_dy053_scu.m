...
cast = '4'; dateoffsetmc = 2016; % origine of the julian day in the matlab cnv files
...
% pf = auto_filt(d.press,1,1/10,'low')
dp=gradient(d.press);
i=find(dp<0.02 & dp>-0.02 & abs(ctdp(1,i)-p(1,i)) < 10);

figure(1);clf;hold on ; grid on ;
plot(dp(i),d.press(i),'ko')
...
plot(d.timeJ(i),d.press(i),'ro');
plot(jd(1,:),p(1,:),'g+')
%%
dp=gradient(p(1,:));
i=find(dp<0.3 & dp>-0.3);
