% mc_call_2_pe399 is a script that performs stage1 processing
...
operator = 'nsm';
moor = 'nocm1_01_2014';
dateoffset = 2014; % year of the first measurement
...
inpath   = [basedir 'data/moor/raw/' cruise '/microcat/NOCM1_recovery/'];
