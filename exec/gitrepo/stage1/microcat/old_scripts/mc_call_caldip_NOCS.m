...
cruise = 'rb0701'; % used for microcat data
cruise2='rb0701'; % used for ctd data
cast = '29';
...
basedir = ['/noc/mpoc/rpdmoc/rapid/data/']; % NOCS
...
ctddir = '/noc/mpoc/rpdmoc/rb0701/ctd/';
...
outpath   = [basedir 'moor/proc_calib/' cruise '/cal_dip/microcat/cast' cast '/reproc/'];
