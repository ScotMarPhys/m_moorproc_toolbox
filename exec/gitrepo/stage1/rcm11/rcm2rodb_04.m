...
% 28 April 2009 - paths changed to RB0901 directories - Paul Wright
...
if a>0
    ...
    procpath='/Users/hydrosea3/Documents/RB0901/rapid/data/moor/proc';
end
...
if a>0
    ...
    inpath=eval(['''/Users/hydrosea3/Documents/RB0901/rapid/data/moor/raw/rb0901/rcm/'';']);
end
...
c_low = c1(ii);    % lower limit of RCM11 conductivity range [mS/cm]PW
c_upp = c2(ii);   % upper limit of RCM11 conductivity range  [mS/cm]PW
...
addpath('/Users/hydrosea3/Documents/RB0901/rapid/data/exec/mfiles/sea/')
addpath(genpath('/Users/hydrosea3/Documents/RB0901/rapid/data/exec/')) 
 if nargin < 7
