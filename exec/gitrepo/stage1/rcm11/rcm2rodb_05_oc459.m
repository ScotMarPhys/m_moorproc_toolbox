% function rcm2rodb_05_oc459(moor, 'procpath', procpath, 'inpath', inpath, ...
%                      'outpath', outpath,'ctd')
%
...
function rcm2rodb_05_oc459(moor,varargin)
...
%else
%    inpath='/noc/ooc/rpdmoc/rapid/data/moor/raw/' cruise '/rcm11/';
end
disp(['inpath = ' inpath])
