% function nortek_raw2use_01(moor,'procpath',procpath,'outpath',outpath)
%
...
function nortek_raw2use_01(moor,varargin)
  
if nargin==0
    help nortek_raw2use_01;
    return
end
...
if a>0
    ...
    plot_interval2(1,1:4)=plot_interval(1:4); 
    plot_interval2(2,1:4)=plot_interval(5:8);
