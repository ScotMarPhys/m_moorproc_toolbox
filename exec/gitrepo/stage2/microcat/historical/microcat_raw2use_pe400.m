...
%      
% May 2016, loh corrects header of the stage2.log (remove mention to spikes) as they are not printed in the log file
...
fprintf(fid_stat,'     ID    Depth   Start         End      Cycles  Gaps   Mean     STD     Max     Min\n');          
...
for proc = 1 : length(sn),
  ...
  if exist(infile)
    ...
    grid on
    xlim([0 jd2-jd1])
    timeaxis(gca,plot_interval(1,1:3));   
