...
id_z_sn.inst(iiODOMC) = {'ODOMC'}; id_z_sn.instl(iiODOMC) = {'microcat'};
id_z_sn.inst(iiRBR) = {'RBR'}; id_z_sn.instl(iiRBR) = {'rbr'};
id_z_sn.inst(iiIDR) = {'IDR'}; id_z_sn.instl(iiIDR) = {'idr'};
id_z_sn.inst(iiS4) = {'S4'}; id_z_sn.instl(iiS4) = {'s4'};
id_z_sn.inst(iiRCM11) = {'RCM11'}; id_z_sn.instl(iiRCM11) = {'rcm11'};
id_z_sn.inst(iiARG) = {'ARG'}; id_z_sn.instl(iiARG) = {'argonaut'};
id_z_sn.inst(iiNOR) = {'NOR'}; id_z_sn.instl(iiNOR) = {'nor'};
id_z_sn.inst(iiDVS) = {'DVS'}; id_z_sn.instl(iiDVS) = {'dvs'};
id_z_sn.inst(iiBPR) = {'BPR'}; id_z_sn.instl(iiBPR) = {'bpr'};
id_z_sn.inst(iiSG) = {'SG'}; id_z_sn.instl(iiSG) = {'seaguard'};
id_z_sn.insts(iiSP) = {'SP'}; id_z_sn.instl(iiSP) = {'seaphox'};
