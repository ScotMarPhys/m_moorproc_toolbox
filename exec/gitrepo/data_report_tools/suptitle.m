...
% will break.
% Loic Houpert, SAMS, 6/01/16, add option to detect the matlab version use
% to prevent crash in the script (Since R2014n, graphical functions
% changed)
...
[VER DATESTR] = version();
ss=regexp(VER,' ','split');
ss2=regexp(ss{1},'\.','split');
vernum = str2num(ss2{1}) + str2num(ss2{2})/10;
