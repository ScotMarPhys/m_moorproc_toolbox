% function pressure_overlay(moor,'procpath','proclvl','layout','plot_interval','unfiltered')
%
...
if unfilt==0
    title(['Low-pass filtered pressure from mooring: ' s])
else
    title(['Unfiltered pressure from mooring: ' s])
end
