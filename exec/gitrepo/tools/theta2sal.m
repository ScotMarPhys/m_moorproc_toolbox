% for given continuous temperature profiles  a  theta/s climatology is used get continuous 
% salinity profiles 
%
% function s = theta2sal(t,TSclim)
%
...
function [si] = theta2sal(ti,TSclim)


% ------- load theta -s  relationship -------------------------
