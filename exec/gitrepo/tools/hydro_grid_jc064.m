...
ini_path     = [basedir 'rpdmoc/rapid/data/moor/proc/hydro_grid/'];
rodbpath     = [basedir '/rpdmoc/rapid/data/moor/'];
rodbctdpath  = [basedir 'rpdmoc/users/tok/rapid/data/'];
info_path    = [rodbpath,'/proc/',moor,'/'];
out_path     = [basedir 'rpdmoc/users/jcol/work/'];
outname      = [moor,'_grid.mat'];

external_ctd        = [[basedir 'rpdmoc/d279/ctd/        '];
    [basedir 'rpdmoc/d344/ctd/rodb/   '];
    [basedir 'rpdmoc/d334/ctd/rodb/   '];
    [basedir 'rpdmoc/sj08/ctd/newctd/ '];
    [basedir 'rpdmoc/rb0901/ctd/rodb/ '];
    [basedir 'rpdmoc/oc459/ctd/rodb/  '];
    [basedir 'rpdmoc/d346/ctd/rodb/   ']];
