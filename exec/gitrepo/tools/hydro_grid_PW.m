...
ini_path    = '/local/users/pstar/Data/rpdmoc/rapid/data/moor/proc/hydro_grid/';
rapid_dir = '/local/users/pstar/Data/rpdmoc/rapid/data/';
paul_dir = '/local/users/pstar/Data/rpdmoc/users/pgw_d344/data_files/';
info_path   = [rapid_dir,'moor/proc/' ,moor, '/'];
out_path    = '/local/users/pstar/Data/rpdmoc/users/pgw_d344/data_files/';  % PW
outname     = ['EBH_hydro_grid_data.mat'];
rodb_ctd            = '/local/users/pstar/Data/rpdmoc/rapid/data/'; % rodbpath for CTD PW
external_ctd        = '/local/users/pstar/Data/rpdmoc/users/pgw_d344/D279_CTD_data/';
external_ctd_file   = 'd279_pos.mat';
proc_path = '/local/users/pstar/Data/rpdmoc/rapid/data/moor/proc/';
