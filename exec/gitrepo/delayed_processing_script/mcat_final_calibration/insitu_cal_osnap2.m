...
average_interval = calp.average_interval(1):20:calp.average_interval(2);
  ...
  if max(average_interval) > max(ctd.press)
  ...
  for i = 1:ninst
    dt_mcdep(i) =  interp1([MP bottle.p0av(oknan,1)'],...
                                [mc.dt(1,i) mc.dt(oknan,i)'],mcdep(i));
    dc_mcdep(i) =  interp1([MP bottle.p0av(oknan,1)'],...
