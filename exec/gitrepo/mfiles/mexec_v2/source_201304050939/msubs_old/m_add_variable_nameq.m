...
% arguments are ncfile structure, var name, var dims (as a cell array) and
...
% % ncfile.metadata = metadata;
% % % % % m_add_default_variable_attributesq(ncfile,string_var_name) % not
% needed in striaght copy because all attributes copied across
toc-toco
disp('v6'); toco = toc;
