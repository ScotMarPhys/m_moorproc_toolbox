function msmoothnav(varargin)

% edit version of mavrge
% intended to make smoothed navigation file
% data are linearly interpolated to centre of each bin, rather than simply
% averaged. BAK 2 Nov 2009.
% At present date (4 Nov 2009) the code only works when averaging
% is 'cols together' 'c', 'rc = 2';
% It should work OK if there happen to be multiple rows.
