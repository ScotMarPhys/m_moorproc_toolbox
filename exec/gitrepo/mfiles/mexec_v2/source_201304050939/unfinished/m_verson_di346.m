...
if ~isnan(Mversionlock) % use lock file
    ...
    while 1
        ...
        m = 'Waiting for version lock file';
...
if ~isnan(Mversionlock) % reset lock file
    ...
    if us == 0 & exist(MEXEC.simplelockfile,'file') == 2 & exist(userlockfile,'file') ~=2 % seems to be a successful rename of lock file
        ...
        m1 = 'problem restoring version lock file in subroutine m_verson.m:';
        m2 = 'needs investigation and repair before any more processing is done';
        m3 = ' ';
        ...
        m12 = '**********';
        fprintf(MEXEC_A.Mfider,'%s\n',m3,m3,m12,m12,m12,m1,m2,m3,m4,m5,m3,m6,m3,m7,m3,m8,m3,m9,m10,m3,m11,m13,m3,m14,m3,m15,m16,m17,m18,m19,m12,m12,m12)
        keyboard
    end
