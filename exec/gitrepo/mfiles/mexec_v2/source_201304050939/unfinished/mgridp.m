...
column = repmat(1:numfiles,numbins,1); % bak on jc069; create column variable so we can repeat isolated deep stations and plot in mcontr
...
v.name = 'column'; v.data = column; v.units = 'number'; m_write_variable(ncfile_ot,v);
