...
% new names for Discovery DY. BAK 31 March 2015.
...
switch MEXEC_G.MSCRIPT_CRUISE_STRING(1:2)
    ...
    case 'dy'
        %  initial config on test data dy018
        matlist = {
            'gravity' ' ' 'AirSeaII-S84_DY1.AirSeaII'
            'winch' ' ' 'CLAM-CLAM_DY1.CLAM'
            'ea600m' ' ' 'EA600-EA640_DY1.EA600'
            'surflight' ' ' 'Light-DY-SM_DY1.SURFMETv2'
            'surfmet' ' ' 'MET-DY-SM_DY1.SURFMETv2'
            'SBE45' ' ' 'SBE45-SBE45_DY1.TSG'
            'surftsg' ' ' 'Surf-DY-SM_DY1.SURFMETv2'
            'cnav' ' ' 'cnav-CNAV.GPS'
            'gyropmv' ' ' 'gyro-GYRO1_DY1.gyr'
            'gyro_s' ' ' 'gyro-SGYRO_DY1.gyr'
            'log_skip' ' ' 'logskippervdvbw-SkipLog.log'
            'posmvpos' ' ' 'position-Applanix_GPS_DY1.gps'
            'seapos' ' ' 'position-Seapath330_DY1.gps'
            'usbpos' ' ' 'position-usbl_DY1.gps'
            ...
            'satinfousb' ' ' 'satelliteinfo-usbl_DY1.gps'
            'em120' ' ' 'sb_depth-EM120_DY1.depth'
            'attposmv' ' ' 'shipattitude-Applanix_TSS_DY1.att'
            'attposmvaux' ' ' 'shipattitude_aux-Applanix_TSS_DY1.att'
            };
    otherwise
end
