...
% MEXEC_G.Mtechsas_root directory
%
...
% end of file names
[MEXEC.status result] = unix(['/bin/ls -1 ' MEXEC_G.Mscs_sed '/*ACO']);
...
%     streams{kf} = fn(17:end);
    streams{kf} = fn(length(MEXEC_G.Mscs_sed)+2:end-4); %list seems to generate full path names
end
