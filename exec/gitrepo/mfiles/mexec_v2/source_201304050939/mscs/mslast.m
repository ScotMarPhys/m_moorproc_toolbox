...
% % % % % % code more techsas version; retrieves data via mtload
% % % % % % This is inconvenient in mscs because it requires updating and loading all
% % % % % % data. Quicker therefore to access ascii data direct. Fragments
% copied in
% % % % % % from other subroutines; msdfifno; msgetfiletimes;
% % % % % [t1 t2 n] = msgetdfinfo(tstream);
% % % % % dn = t2;
% % % % % 
% % % % % ms_update_aco_to_mat(tstream);
% % % % % % keyboard
% % % % % [pdata punits] = msload(tstream,dn,dn,'/','q');
% % % % % % matlabdate = datevec(pdata.time+MEXEC_G.Mtechsas_torg);
