...
%    corresponds to an error.  You can use the 'STRERROR' function to get a 
%    string description of return status.  
% 
%    "Ncid" refers to the netCDF file ID, "dimid" refers to a netCDF dimension 
%    ID, and "varid" refers to a netCDF variable ID.
% 
