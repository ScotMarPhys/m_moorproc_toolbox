...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% $Id: test_nc_addnewrecs.m 2528 2008-11-03 23:06:25Z johnevans007 $
...
if getpref('SNCTOOLS','USE_TMW',false)
    ...
    ydimid = netcdf.defDim(ncid, 'y', 1 );
    zdimid = netcdf.defDim(ncid, 'z', 1 );
    
    
    len_t = 0;
    ydimid = netcdf.defDim(ncid, 'time', 0 );
...
if getpref('SNCTOOLS','USE_TMW',false)
    ...
    len_x = 4;
    xdimid= netcdf.defDim(ncid, 'x', len_x );
    tdimid= netcdf.defDim(ncid, 'time', 0 );
    netcdf.close(ncid );
else
    %
    % ok, first create this baby.
