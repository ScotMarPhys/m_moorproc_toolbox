...
#
            ...
            CXXFLAGS="$CXXFLAGS -I$(NETCDF)/include "
            CXXLIBS="$RPATH $MLIBS -lm"
            CXXOPTIMFLAGS='-O -DNDEBUG'
            CXXDEBUGFLAGS='-g'
#
...
#           CLIBS="$CLIBS"
#
### vanilla settings, glnxa64
### NetCDF library compiled with CXXFLAGS="-fPIC" and "--disable-shared"
            NETCDF="/home/johne/local/netcdf-3.6.3/glnxa64"
