...
% Loic Houpert, 6 January 2015 : add a missing *100 factor (unit in cm.s in the stage1.log file) for the median calculation of u,v,w and speed line 186:188
% and 196
...
for i = 1:length(filenames)
    ...
    if a(2)==27 % I THINK THIS IS RIGHT FOR USING "SOUNDSPEED USED" rather than just SOUNDSPEED for newer Norteks. Need to check really.
        disp(' Newer version of the software used')
    ...
    m_u = median(u(valI,:)*100);
    m_v = median(v(valI,:)*100);
    m_w = median(w(valI,:)*100);
    ...
    fprintf(fidlog,'Median direction                                    : %5.2f\n',m_dir);
