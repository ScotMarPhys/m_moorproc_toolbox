% function nortek2rodb_cal_dip_01(moor,'inpath','outpath','procpath')
...
% DR, 14/111/12 - updated so can set basedir

function nortek2rodb_cal_dip_01(moor, varargin)
...
if nargin==0
    help nortek2rodb_01_cal_dip_01
    return
end
...
if a>0
    ...
    procpath=[basedir '/rapid/data/moor/proc_calib/'];
end
