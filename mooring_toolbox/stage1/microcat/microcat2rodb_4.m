...
%          June 2015 - loh slightly changes in the timeoffset parameter into dateoffset, to take care of julian day format 
...
% Loic
disp([min([min(dt(:,3)) 0])  max(dt(:,3))])
      set(gca,'ylim',[min([min(dt(:,3)) 0])  max(dt(:,3))])
  end
