...
%     end
    ...
    if percentG>0
     ...
     h=image(pg4 + pg1,'xdata',x,'ydata',y);colormap(color1);colorbar;
     %text(100,1,['Max value  = ',num2str(maxpg4)]);
     ...
     vardescription.pg1   = 'percent good 4: The percentage of measurements with three-beam solutions';     
     vardescription.badarea = 'Area outside which the value should be set to nan, in order to not have gaps in the different bin time-series';       
     ...
     if exist(matpgfourfile)==2
        ...
        if (strcmp(ierase,'y')||strcmp(ierase,'Y')||strcmp(ierase,'yes')||strcmp(ierase,'Yes')||strcmp(ierase,'YES'))
            ...
            save(matpgfourfile, 'ibaddata','scannber','binnber','mtime','pg4','pg1');
